...
SECRET_KEY = 'django-insecure-1lxejp)zo*y4ypar@*ip)iwxgj#ovvs^7#t6s-gwguz_5#v8bh'
...
DATABASES['default'] = dj_database_url.parse('mysql://root:pkd131416@localhost/my_database_1090')
